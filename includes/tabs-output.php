...
<form method="post" action="admin-post.php">
	...
	<input type="submit" name="btn_save" value="<?php esc_html_e( 'Save Settings', 'azrcrv-uam' ); ?>" class="button-primary"/>
</form>
<?php
/*
...
<div class='azrcrv-donate'>
	<?php
		printf( esc_html__( 'Support %s', 'azrcrv-uam' ), esc_html( DEVELOPER_NAME ) );
	?>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-uam' );
		?>
	</span>
</div>
