...
* Download the latest release of the plugin from [GitHub](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/latest/).
...
### [Version 2.0.5](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/tag/v2.0.5)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 2.0.4](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/tag/v2.0.4)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 
### [Version 2.0.3](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/tag/v2.0.3)
 * Fix bug with removal of menu options not working unless page= set.
 * Update Update Manager to version 2.5.0.
 * Update readme and plugin header for compatibility with ClassicPress v2.
...
### [Version 1.1.1](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/tag/v1.1.1)
...
### [Version 1.0.1](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/tag/v1.0.1)
 * Fix issue with updateclient namespace.

### [Version 1.0.0](https://github.com/azurecurve/azrcrv-update-admin-menu/releases/tag/v1.0.0)
 * Initial release.
