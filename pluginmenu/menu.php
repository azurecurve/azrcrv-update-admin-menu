 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_uam')){
	function azrcrv_create_plugin_menu_uam(){
		azrcrv_populate_plugin_menu_uam();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_uam')){
	function azrcrv_populate_plugin_menu_uam(){
